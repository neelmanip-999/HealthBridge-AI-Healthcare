...
const Appointment = () => {
  ...
  return docInfo && (
    <div>
      ...
      {/* --------- Booking Slots ---------- */}
      <div className='sm:ml-72 sm:pl-4 mt-4 font-medim text-gray-700'>
        <p>Booking slots</p>
        ...
        <button className='bg-primary text-white text-sm font-light px-14 py-3 rounded-full my-6 cursor-pointer hover:bg-primary/90 transition-all duration-300'>

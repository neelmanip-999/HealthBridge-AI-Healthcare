// HealthBridge/frontend/src/pages/DoctorLogin.jsx
...
const DoctorLogin = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-indigo-50 via-blue-50 to-purple-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="bg-white/80 backdrop-blur-sm p-10 rounded-3xl shadow-2xl w-full max-w-md border border-indigo-100 relative z-10 animate-fadeInUp">
        {/* Header */}
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-500">
            ...
            <Link to="/doctor/register" className="text-indigo-600 hover:text-indigo-800 font-semibold ml-1 transition-colors duration-200 hover:underline">
              Register here
            </Link>
          </p>
        </div>

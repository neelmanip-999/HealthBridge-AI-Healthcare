    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 p-6 md:p-10 relative overflow-hidden">
            ...
            <main className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="bg-white/80 backdrop-blur-sm p-10 rounded-3xl shadow-2xl border border-green-100 hover-lift animate-slideInRight" style={{ animationDelay: '0.4s' }}>
